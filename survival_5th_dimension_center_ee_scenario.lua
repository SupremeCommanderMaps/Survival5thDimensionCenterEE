...
ScenarioInfo = {
    ...
    preview = '',
    size = {512, 512},
    map = '/maps/survival_5th_dimension_center_ee.v0001/survival_5th_dimension_center_ee.scmap',
    save = '/maps/survival_5th_dimension_center_ee.v0001/survival_5th_dimension_center_ee_save.lua',
    script = '/maps/survival_5th_dimension_center_ee.v0001/survival_5th_dimension_center_ee_script.lua',
