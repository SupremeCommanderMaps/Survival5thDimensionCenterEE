...
ScenarioInfo = {
    ...
    map_version=5,
    description = 'Survive for 35 minutes and defend the Defence Object at the center of the map. Can be played with less than 4 players, as the map adjusts to the player count.',
    type = 'skirmish',
    starts = true,
    preview = '',
    size = {512, 512},
    map = '/maps/survival_5th_dimension_center_ee.v0005/survival_5th_dimension_center_ee.scmap',
    save = '/maps/survival_5th_dimension_center_ee.v0005/survival_5th_dimension_center_ee_save.lua',
    script = '/maps/survival_5th_dimension_center_ee.v0005/survival_5th_dimension_center_ee_script.lua',
